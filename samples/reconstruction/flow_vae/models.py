...
__doc__ = r'''
           '''
import numpy as np
import samples.reconstruction.vanilla_vae.vae_flow as flow
import torch
import torch.utils
...
class Generator(nn.Module):
  ...
  def __init__(self, latent_size, data_size):
    ...
    self.generative_network = MLP(input_size=latent_size,
...
class VariationalMeanField(nn.Module):
  ...
  def __init__(self, latent_size, data_size):
    super().__init__()
    self.inference_network = MLP(input_size=data_size,
