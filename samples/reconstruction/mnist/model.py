...
from vision.reconstruction.vqvae2.pixel_cnn import PixelCNN, PixelConvA, PixelConvB
from vision.reconstruction.vqvae2.vq_vae import QuarterDecoder, QuarterEncoder, VQVAE
...
class Generator(nn.Module):
  def __init__(self):
    ...
    self.model = PixelCNN(PixelConvA(64, 64),
