...
from draugr.visualisation.pillow_utilities import byte_array_to_pil_image, pil_image_to_byte_array
...
def on_message(client, userdata, msg):
  ...
  try:
    client.publish(MQTT_PUBLISH_TOPIC, pil_image_to_byte_array(byte_array_to_pil_image(msg.payload).rotate()), qos=MQTT_QOS)
