...
public class ClassifyCamera extends AppCompatActivity {
    private static final String TAG = "AIDEMO";
    ...
    static {
        System.loadLibrary("caffe2_native_lib");
    }

    public native String Classify(int h,
                                  int w,
                                  byte[] Y,
                                  byte[] U,
                                  byte[] V,
    ...
    public native String InitModel(AssetManager mgr, String init_name, String pred_name);
    ...
    private class SetUpNeuralNetwork extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void[] v) {
            try {
                ...
                String MODEL_INIT_NAME= "init_net.pb";
                String MODEL_PRED_NAME= "predict_net.pb";
                predictedClass = InitModel(mgr, MODEL_INIT_NAME, MODEL_PRED_NAME);
            ...
            ImageReader.OnImageAvailableListener readerListener = new ImageReader.OnImageAvailableListener() {
                ...
                public void onImageAvailable(ImageReader reader) {
                    try {
                        ...
                        predictedClass = Classify(h, w, Y, U, V,
