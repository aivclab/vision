...
public class Constants {
  ...
  static String[] IMAGENET_CATEGORIES = new String[]{"tench, Tinca tinca",
  ...
  static String[] VESTAS_CATEGORIES = new String[]{"ashtray","mug","Nothing","asdsad"};

  static String[] CATEGORIES = VESTAS_CATEGORIES;
}
