#!/usr/bin/env python3
# -*- coding: utf-8 -*-
from samples.regression.reconstruction import load_binary_mnist
from samples.regression.reconstruction import Generator, VariationalFlow, VariationalMeanField
