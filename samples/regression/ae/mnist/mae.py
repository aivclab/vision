        ...
        with OverfitDetector(patience=10) as is_overfitting:
            for update_i in sess:
                for phase in [SplitEnum.training, SplitEnum.validation]:
                    ...
                    if phase == SplitEnum.validation and is_overfitting(update_loss):
                        break
                    ...
                    if phase == SplitEnum.validation and update_loss < best_loss:
                        ...
                        writer.image(
                            f"rgb_imgs", rgb_imgs, update_i, data_formats=_format
                        )
                        writer.image(
...
def train_mnist(load_earlier=False, train=True, denoise: bool = True) -> None:
    """
