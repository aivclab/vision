...
from neodroidvision.reconstruction import Decoder, Encoder, VQVAE
...
def make_vae():
    return VQVAE(
        [BottomEncoder(), HighEncoder(), HighEncoder()],
        [
            HierarchyDecoder(512, 512, 1),
            HierarchyDecoder(512, 512, 2),
