...
from samples.regression.reconstruction import load_text_samples
from samples.regression.reconstruction.vq_vae2.text.model import make_vae
...
def main():
    ...
    for i, batch in enumerate(
        load_text_samples(args.data, args.batch_size, args.context_len)
    ):
...
def arg_parser():
    ...
    parser.add_argument(
        "--context-len", help="context size in bytes", default=512, type=int
    )
