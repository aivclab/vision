...
from samples.regression.reconstruction.vq_vae2.hierarchical.model import (
    TopPrior,
    make_vae,
)
from samples.regression.reconstruction.vq_vae2.hierarchical.train_top import (
    TOP_PRIOR_PATH,
)
...
def main():
    ...
    Image.fromarray((decoded * 255).astype(numpy.uint8)).save(
        PROJECT_APP_PATH.user_data / "top_samples.png"
    )
