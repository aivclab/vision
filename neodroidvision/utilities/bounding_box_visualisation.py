...
def draw_bounding_boxes_on_image(
    image, boxes, labels_iterable: Optional[Iterable] = None, *, color: ColorEnum = None,
    thickness:Number=2
    ):
...
def draw_keypoints_on_image(
    image, keypoints, color:ColorEnum=None, radius:Number=2, use_normalized_coordinates:bool=True
    ):
...
def draw_mask_on_image_array(image, mask, color: ColorEnum=None, alpha:float=0.4,
                             mode:PilModesEnum=PilModesEnum.RGBA):
