...
from neodroidvision.utilities.bounding_box_visualisation import (_visualize_boxes,
...
def add_cdf_image_summary(values, name):
  ...
  tensorflow.summary.image(name, tensorflow.py_func(cdf_plot, [values], tensorflow.uint8))
...
def add_hist_image_summary(values, bins, name):
  ...
  tensorflow.summary.image(name, tensorflow.py_func(hist_plot, [values, bins], tensorflow.uint8))
