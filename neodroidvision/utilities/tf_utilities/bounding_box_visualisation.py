...
"""
  ...
  images = tensorflow.map_fn(draw_boxes, elems, dtype=tensorflow.uint8, back_prop=False)
  return images
...
def draw_mask_on_image_array(image, mask, color="red", alpha=0.4, mode="RGBA"):
...
"""
  ...
  cdf_plot = tensorflow.py_func(cdf_plot, [values], tensorflow.uint8)
  tensorflow.summary.image(name, cdf_plot)
...
"""
  ...
  hist_plot = tensorflow.py_func(hist_plot, [values, bins], tensorflow.uint8)
  tensorflow.summary.image(name, hist_plot)
