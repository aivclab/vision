...
from neodroidvision.data.datasets.supervised.classification.imagenet.imagenet_2012_id import (
    categories_id,
)
from neodroidvision.data.datasets.supervised.classification.imagenet.imagenet_2012_names import (
    categories_names,
)
