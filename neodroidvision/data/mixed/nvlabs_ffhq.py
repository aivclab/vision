...
class FFHQDataset(Dataset):
    ...
    def __init__(self, json_data, source_dir, transform=None):
        """
    ...
    def load_image_from_disk(self, item):
        """
    ...
    def load_image_from_disk_path(self, path):
        """
