...
def main(test_cuda=False):
  ...
  ct = CenterLoss(10, 2, size_average=True).to(get_torch_device())
  y = torch.Tensor([0, 0, 2, 1]).to(get_torch_device())
  feat = torch.zeros(4, 2).to(get_torch_device()).requires_grad_()
