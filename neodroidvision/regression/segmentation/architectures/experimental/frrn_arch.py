...
from neodroidvision.regression.segmentation import (conv2DBatchNorm,
                                                    conv2DBatchNormRelu,
                                                    conv2DGroupNormRelu,
                                                    )
...
class RU(nn.Module):
  ...
  def __init__(self, channels, kernel_size=3, strides=1, group_norm=False, n_groups=None):
    ...
    if self.group_norm:
      self.conv1 = conv2DGroupNormRelu(channels,
                                       channels,
                                       k_size=kernel_size,
                                       stride=strides,
                                       padding=1,
      ...
      self.conv2 = conv2DGroupNorm(channels,
                                   channels,
                                   k_size=kernel_size,
                                   stride=strides,
                                   padding=1,
      ...
      self.conv1 = conv2DBatchNormRelu(channels,
                                       channels,
                                       k_size=kernel_size,
                                       stride=strides,
                                       padding=1,
      ...
      self.conv2 = conv2DBatchNorm(channels,
                                   channels,
                                   k_size=kernel_size,
                                   stride=strides,
                                   padding=1,
