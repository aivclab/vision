#!/usr/bin/env python3
# -*- coding: utf-8 -*-
from neodroidvision.multitask.fission_net.skip_bottle_neck.compress import Compress
from neodroidvision.multitask.fission_net.skip_bottle_neck.decompress import Decompress
