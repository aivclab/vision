...
def plot_sphere(w=0, c=(0, 0, 0), r=(1, 1, 1), sub_divisions=10, ax=None, sigma_multiplier=3):
  '''
  ...
  cos = numpy.cos
  sin = numpy.sin
  phi, theta = numpy.mgrid[0.0:pi:complex(0, sub_divisions), 0.0:2.0 * pi:complex(0, sub_divisions)]
