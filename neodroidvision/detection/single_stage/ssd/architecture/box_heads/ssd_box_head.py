...
from neodroidvision.detection.single_stage.ssd.architecture.box_heads.box_predictor import (
    BoxPredictor,
)
  ...
  """
    ...
    """
        ...
        for (scores, boxes) in zip(
            functional.softmax(categori_logits, dim=-1),
...
"""
        ...
        results = SSDOut(*[to_tensor(x) for x in zip(*results)])
        return results
