...
from neodroidvision.detection.single_stage.ssd.architecture.layers import L2Norm
from neodroidvision.detection.single_stage.ssd.ssd_utilities.storage import (
    load_state_dict_from_url,
)

model_urls = {"vgg": "https://s3.amazonaws.com/amdegroot-models/vgg16_reducedfc.pth"}
