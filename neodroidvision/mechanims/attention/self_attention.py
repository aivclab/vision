...
def spectral_norm_conv2d(in_channels,
                         out_channels,
                         kernel_size,
                         stride=1,
                         padding=0,
...
class SelfAttentionModule(nn.Module):
  ...
  def __init__(self, in_channels):
    ...
    self.spectral_norm_conv1x1_theta = spectral_norm_conv2d(in_channels=in_channels,
                                                            out_channels=in_channels // 8,
                                                            kernel_size=1,
                                                            stride=1,
                                                            padding=0)
    self.spectral_norm_conv1x1_phi = spectral_norm_conv2d(in_channels=in_channels,
                                                          out_channels=in_channels // 8,
                                                          kernel_size=1,
                                                          stride=1,
                                                          padding=0)
    self.spectral_norm_conv1x1_g = spectral_norm_conv2d(in_channels=in_channels,
                                                        out_channels=in_channels // 2,
                                                        kernel_size=1,
                                                        stride=1,
                                                        padding=0)
    self.spectral_norm_conv1x1_attn = spectral_norm_conv2d(in_channels=in_channels // 2,
