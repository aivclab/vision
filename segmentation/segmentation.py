...
from Vision.segmentation.losses.accum import calculate_accum_loss
from Vision.segmentation.models.aeunet import AEUNet
...
def main():
  ...
  aeu_model = AEUNet(3, start_filters=16, depth=3)
